...
<div class="swiper-container" style="overflow: hidden">
    ...
    <div class="swiper-wrapper" style="height:auto">
        ...
        <div class="swiper-slide"><img
                srcset="${pageContext.request.contextPath}/img/banner01_1600w.png 1600w,
                        ${pageContext.request.contextPath}/img/banner01_320w.png 320w,
                        ${pageContext.request.contextPath}/img/banner01_800w.png 800w"
                sizes="1580px,
                       (max-width: 767px) 320px,
                       (max-width: 1023px) 800px"
                style="width:100%; height: auto;"></div>
        <div class="swiper-slide"><img
                srcset="${pageContext.request.contextPath}/img/banner02_1600w.png 1600w,
                        ${pageContext.request.contextPath}/img/banner02_320w.png 320w,
                        ${pageContext.request.contextPath}/img/banner02_800w.png 800w"
                sizes="1580px,
                       (max-width: 1023px) 800px,
                       (max-width: 767px) 320px"
                style="width:100%; height: auto;"></div>
        <div class="swiper-slide"><img
                srcset="${pageContext.request.contextPath}/img/banner03_1600w.png 1600w,
                        ${pageContext.request.contextPath}/img/banner03_320w.png 320w,
                        ${pageContext.request.contextPath}/img/banner03_800w.png 800w"
                sizes="1580px,
                       (max-width: 1023px) 800px,
                       (max-width: 767px) 320px"
                style="width:100%; height: auto;"></div>
    ...
    <div class="swiper-button-prev" style="margin-top:-200px"></div>
    <div class="swiper-button-next" style="margin-top:-200px"></div>
</div>
<br><br>
<div align="center" class="container" style="width:100%; height:auto; color:hotpink; padding-top:20px">
    <h3>HOT</h3>
...
<div align="center">
    ...
    <div style="display:inline-block; width:500px;" align="center">
        <a href="/muscle/board/openBoardList.do" style="text-decoration:none; color:#000000;"><h3
                style="margin-bottom:10px; color:hotpink;">Hot</h3></a>
        <ul class="list-group list-group-flush">
            <c:forEach items="${list}" var="row">
                <c:if test="${session_MEMBER.MEM_NUM != null}">
                    <li class="list-group-item">
                        <a href="#this" name="Btitle" style=color:hotpink;>${row.BOARD_TITLE}
                            [${row.TOTAL_COMMENTS}]</a>
                        <input type="hidden" id="BOARD_NUM" value="${row.BOARD_NUM}"></li>
                </c:if>
                <c:if test="${session_MEMBER.MEM_NUM == null}">
                    <li class="list-group-item">
                        <a href="#this" name="titleles" style=color:hotpink;>${row.BOARD_TITLE}
                            [${row.TOTAL_COMMENTS}]</a>
                        <input type="hidden" id="BOARD_NUM" value="${row.BOARD_NUM}"></li>
                </c:if>
            </c:forEach>
