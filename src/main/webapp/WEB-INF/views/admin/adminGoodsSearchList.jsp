...
<div class="container" style="margin-top:20px;">
   ...
   <table align="center" name="adminGoodsSearchList" class="table table-hover" style="cellpadding:7px;">
      <thead>
...
<div style="height:80px;">
   ...
   function fn_delete(obj){
    ...
    $(document).ready(function() {
     ...
     function fn_adminGoodsSearchList(pageNo) { //페이징 함수
        var comAjax = new ComAjax();
     
        comAjax.setUrl("<c:url value='/admin/SearchGoods.do' />");//open으로 하면 콜백함수 전송이 안됨.
        comAjax.setCallback("fn_adminGoodsSearchListCallback"); //ajax요청 후 호출될 함수의 이름 지정
     ...
     function fn_adminGoodsSearchListCallback(data) {
        var total = data.TOTAL;    
        var body = $("table[name='adminGoodsSearchList']>tbody");
        body.empty();
        if (total == 0) {
           ...
           var params = {
                   ...
                   totalCount : total,
                   recordCount : 10,
                   eventName : "fn_adminGoodsSearchList",
           };
