...
<form:form modelAttribute="joinVO" id="frm" name="frm" class="form-inline" method="post" action="/muscle/member/insertKakaoJoin">
...
<script type="text/javascript">
      ...
      function fn_insertJoin() {
         ...
         comSubmit.setUrl("<c:url value='/member/insertKakaoJoin' />");
