...
<c:if test="${session_MEMBER.MEM_ADMIN == 'Y'}">
   <ul class="nav nav-tabs">
     ...
     <li class="nav-item">
       <a class="nav-link active" href="<c:url value='/admin/acsBoardList.do'/>">공지관리</a>
     </li>
   </ul>
</c:if>
   ...
   <table align="center" class="table table-hover" style="cellpadding:7px;">
      ...
      <div align="right">
      <c:if test="${session_MEMBER.MEM_ADMIN == 'Y'}">
      <button type="button" class="btn btn-primary btn-sm" onclick="location.href='/muscle/admin/openAcsWrite.do'">글 작성</button>
